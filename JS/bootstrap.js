        ...
        666: function (t, e, i) {
          t.exports = (function (t) {
            ...
            class Z extends R {
              ...
              _initEvents() {
                this._supportPointerEvents
                  ? (H.on(this._element, "pointerdown.bs.swipe", (t) =>
                      this._start(t)
                    ),
                    H.on(this._element, "pointerup.bs.swipe", (t) =>
                      this._end(t)
                    ),
                    this._element.classList.add("pointer-event"))
                  : (H.on(this._element, "touchstart.bs.swipe", (t) =>
                      this._start(t)
                    ),
                    H.on(this._element, "touchmove.bs.swipe", (t) =>
                      this._move(t)
                    ),
                    H.on(this._element, "touchend.bs.swipe", (t) =>
                      this._end(t)
                    ));
              }
            ...
            class ht extends V {
              ...
              _maybeEnableCycle() {
                this._config.ride &&
                  (this._isSliding
                    ? H.one(this._element, st, () => this.cycle())
                    : this.cycle());
              }
              to(t) {
              ...
              _setActiveIndicatorElement(t) {
                ...
                i &&
                  (i.classList.add(rt), i.setAttribute("aria-current", "true"));
              }
              _updateInterval() {
            ...
            H.on(document, "click.bs.collapse.data-api", pt, function (t) {
              ...
              const e = o(this),
                i = U.find(e);
              for (const t of i)
                _t.getOrCreateInstance(t, { toggle: !1 }).toggle();
            }),
              b(_t);
            const bt = "dropdown",
              vt = "ArrowUp",
            ...
            class jt extends V {
              ...
              static dataApiKeydownHandler(t) {
                ...
                const s = this.matches(Tt)
                    ...
                    : U.prev(this, Tt)[0] ||
                      U.next(this, Tt)[0] ||
                      U.findOne(Tt, t.delegateTarget.parentNode),
            ...
            class se extends V {
              ...
              show(t) {
                this._isShown ||
                  ...
                  H.trigger(this._element, Jt, { relatedTarget: t })
                    .defaultPrevented ||
                  ((this._isShown = !0),
                  (this._isTransitioning = !0),
            ...
            const pe = new Set([
              ...
              _e = (t, e) => {
                ...
                return e.includes(i)
                  ? !pe.has(i) ||
                      Boolean(ge.test(t.nodeValue) || me.test(t.nodeValue))
                  ...
                  if ("click" === e)
                    ...
                    H.on(this._element, t, this._config.selector, (t) => {
                      ...
                      H.on(this._element, i, this._config.selector, (t) => {
                        const e = this._initializeOnDelegatedTarget(t);
                        (e._activeTrigger["focusout" === t.type ? Le : ke] =
            ...
            class Je extends V {
              ...
              show() {
                ...
                const e = this._getActiveElem(),
                  i = e
                    ? H.trigger(e, "hide.bs.tab", { relatedTarget: t })
                    : null;
